...
export default function CopyField({
  ...
  return (
    <div className="flex w-fit mx-auto m-2 p-4 text-lg bg-red-500">
      <div className="pr-4">
        {text}
      </div>
      {!copied ?
        <div id="copy" className="cursor-pointer" title={`Copy ${text} to your clipboard`} onClick={copy}>
        ...
        </div> : <div id="copied" title="Copied!">
